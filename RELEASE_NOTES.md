...
## 16.0.0-preview.1 — Adaptive Runtime Parameters (unpublished candidate)
...
- Add versioned `TemporalVisualJson` and safe `TemporalSvgRenderer` adapters over the typed scene.
