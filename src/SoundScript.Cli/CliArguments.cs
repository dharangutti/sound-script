...
public sealed class CliArguments
{
    ...
    private void Validate()
    {
        ...
        {
            if (Value("mode") is { } mode && mode is not ("monophonic" or "extract-melody")) throw new CliUsageException("--mode requires monophonic or extract-melody.");
