...
public sealed class CliArguments
{
    ...
    private void Validate()
    {
        ...
        {
            if (Value("mode") is { } mode && mode is not ("monophonic" or "extract-melody" or "polyphonic")) throw new CliUsageException("--mode requires monophonic, extract-melody or polyphonic.");
