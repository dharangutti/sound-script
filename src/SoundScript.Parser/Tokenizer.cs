...
public sealed class Tokenizer
{
    private static readonly Dictionary<string, TokenType> Keywords = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["articulation"] = TokenType.PhraseArticulation,
        ["crescendo"] = TokenType.Crescendo,
        ["decrescendo"] = TokenType.Decrescendo,
        ...
        ["gentle"] = TokenType.Identifier,
        ["strong"] = TokenType.Identifier,
        ["aggressive"] = TokenType.Identifier,
        ["expressive"] = TokenType.Identifier,
        ["swell"] = TokenType.Identifier,
        ["fade"] = TokenType.Identifier,
        ["smooth"] = TokenType.Identifier,
        ["abrupt"] = TokenType.Identifier,
        ["sharp"] = TokenType.Identifier,
        ["detached"] = TokenType.Identifier,
