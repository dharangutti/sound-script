...
changes CLI commands. The package contains the reusable libraries, their XML
IntelliSense documentation, and the vocal corpus, without CLI or Playground binaries.
